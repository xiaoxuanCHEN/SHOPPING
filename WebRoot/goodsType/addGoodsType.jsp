			...
			<div class="container-fluid">
				<div class="info-center">
					...
					<div class="addtype">
						...
						<form action="../doGoodsTypeList?type=addty" method="post">
							<div class="style">
								<span>类型名称：</span> <input type="text" class="tyname" name="name">
							</div>
							<div class="style1">
								<span>备注说明：</span><br>
								<textarea rows="5" cols="40" class="remark" name="remark">
			        </textarea>
							</div>
							<div class="style1">
